...
namespace HereIsJapan.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TravelStories", x => x.StoryID);
                    table.ForeignKey(
                        name: "FK_TravelStories_Cities_CityID",
                        column: x => x.CityID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TravelStoryStoryID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_TravelStories_TravelStoryStoryID",
                        column: x => x.TravelStoryStoryID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_TravelStoryStoryID",
                table: "Comments",
                column: "TravelStoryStoryID");

            migrationBuilder.CreateIndex(
                name: "IX_TravelStories_CityID",
                table: "TravelStories",
                column: "CityID");
